...
public class OrderActivityBasicTest {
    ...
    @Rule
    public ActivityTestRule<OrderActivity> mOrderActivityActivityTestRule =
    ...
    public void clickDecrementButton_ChangesQuantityAndCost() {
        ...
        //3. Check if view does what you expected
        ...
        //          - Check that the initial quantity
        onView(withId(R.id.quantity_text_view)).check(matches(withText("0")));
        //          - Click on the decrement but
